...
const PasswordReset = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setSuccessMessage('If this email is registered, a password reset link will be sent shortly. Please check your junk folder if it does not arrive within a few minutes.');
        } catch (err) {
